...
class Nature(Enum):
    ...
    def relation(self, other: Nature, connections = {
        LEADER_OF_THE_GANG: {LEADER_OF_THE_GANG: -.25, NINJA_INVESTIGATOR: .4, PARTY_GOING: .3, LONE_TIGER: -.2},
        NINJA_INVESTIGATOR: {LEADER_OF_THE_GANG: .15, PARTY_GOING: .3 ,LONE_TIGER: .1},
        ...
        BUSY_GOSSIP: {LEADER_OF_THE_GANG: .2, PARTY_GOING: .5, LONE_TIGER: -.05, COMFORT_CONNAISSEUR: -.08, BUSY_GOSSIP: .05}
    }):
